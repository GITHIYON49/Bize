...
const Banner = ({data}) => {
  return <>
  <section className='w-full h-auto md:h-[450px] bg-orange-600 flex flex-col md:flex-row items-center justify-center'>
    <div className='w-full md:w-1/2 lg:w-[55%] h-full flex items-center justify-center py-10 md:py-0'>
        ...
        <h1 className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold'>{data.heading}</h1>
        {
          data?.description && (
    ...
    <div className='w-full h-auto md:w-1/2 md:h-[80%] lg:h-full lg:w-[45%]'>
        <img src={data.picture} alt="building" className='w-full h-full object-cover' />
    </div>
  </section>
